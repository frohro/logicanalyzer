...
To modify the clock frequency, change the `FPGA_CLOCK_FREQUENCY` define in `LogicAnalyzer_Board_Settings.h` for the `BUILD_PICO_ICE` configuration.

For example, to set 20MHz:
```c
#define FPGA_CLOCK_FREQUENCY 20000000.0f
```
